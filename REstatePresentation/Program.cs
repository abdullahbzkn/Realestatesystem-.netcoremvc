...
builder.Services.AddScoped<IServiceHousingPhotoService, ServiceHousingPhotoManager>();
builder.Services.AddScoped<IServiceHousingPhotoDal, EfServiceHousingPhotoDal>();
builder.Services.AddScoped<IServiceTerrainPhotoService, ServiceTerrainPhotoManager>();
builder.Services.AddScoped<IServiceTerrainPhotoDal, EfServiceTerrainPhotoDal>();
